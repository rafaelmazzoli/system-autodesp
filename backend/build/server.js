    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _fawn["default"].init(_mongoose["default"]);
          ...
          //Client React Router
          app.use(_express["default"]["static"](_path["default"].join(__dirname, "../../desktop/build")));
          app.get("*", function (req, res) {
            res.sendFile(_path["default"].join(__dirname, "../../desktop/build", "index.html"));
          });

          //Rotas de Erro Genérico
          app.use(function (err, req, res, next) {
            res.status(500).send("Algum erro aconteceu no servidor. Entre em contato com o Rafael.\n\nErro:\n".concat(err));
          });
          app.listen({
            port: 3333
          }, function () {
